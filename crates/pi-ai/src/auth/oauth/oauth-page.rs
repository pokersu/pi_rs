//! Rust 翻译自 packages/ai/src/auth/oauth/oauth-page.ts
...
fn render_page(options: RenderPageOptions<'_>) -> String {
    ...
    let details_html = match &details {
...
/// 对应 `oauthErrorHtml(message, details?)`。
